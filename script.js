...
// Arrastar o botão flutuante do WhatsApp (mouse e touch)
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Converte posição fixa (bottom/right) para (top/left) antes de arrastar
  ...
  function onPointerDown(e) {
    // Evita abrir o link quando intenção é arrastar
    e.preventDefault();
  ...
  function onPointerMove(e) {
    ...
    // Marca como movimento quando ultrapassa um pequeno limiar
    ...
    const clampedLeft = clamp(newLeft, 8, vw - btnRect.width - 8);
    const clampedTop = clamp(newTop, 8, vh - btnRect.height - 8);
  ...
  function onPointerUp() {
    ...
    // Marca que o usuário reposicionou manualmente; não auto-ajustar mais
    btn.dataset.userMoved = "true";
  ...
  // Impede navegação se o último gesto foi um arrasto
  btn.addEventListener("click", (e) => {
    if (hasMoved) {
      e.preventDefault();
      e.stopImmediatePropagation();
      // Reseta o estado após suprimir o clique do arrasto
      hasMoved = false;
    }
  });
});
